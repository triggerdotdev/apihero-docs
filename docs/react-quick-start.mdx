...
If you are using Next.js and want to proxy server requests, you need to check that your tsconfig.json file has `"moduleResolution": "nodenext"` in the `compilerOptions` section. See the [Node docs](/node-quick-start#2-check-your-tsconfigjson-configuration-if-youre-using-typescript) for more information.
